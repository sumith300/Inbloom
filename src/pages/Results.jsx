              ...
              >
                <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
                  ...
                  <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 w-full sm:w-auto">
                    ...
                    >
                      <div className="flex flex-col items-center bg-gradient-to-br from-secondary/10 to-secondary-light/10 p-4 rounded-xl backdrop-blur-sm border border-white/10 shadow-xl">
